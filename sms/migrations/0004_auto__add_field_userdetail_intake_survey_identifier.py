...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserDetail.intake_survey_identifier'
        db.add_column('sms_userdetail', 'intake_survey_identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=110), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserDetail.intake_survey_identifier'
        db.delete_column('sms_userdetail', 'intake_survey_identifier')
    ...
    models = {
        ...
        'sms.userdetail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intake_survey_identifier': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '110'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
