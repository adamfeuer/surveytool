...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sms_membership', 'messages_generated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membership.messages_generated'
        db.delete_column('sms_membership', 'messages_generated')
